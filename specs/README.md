...
| [`006-schema-expressiveness-and-optimization.md`](006-schema-expressiveness-and-optimization.md) | スキーマ表現力 & 最適化強化仕様                      | `Draft`       | [#50](https://github.com/high-soar/taskweave/issues/50)                                                                                                                                                                                                                                     | 原本 YAML のルートキー対称性統一、非推奨警告ポリシー、メンバー個別稼働曜日、担当者指定、負荷平準化の仕様 |
