...
仕様書のカタログは root の [`index.md`](../index.md) の Documents セクションに集約されています。人間向けの概要は以下の表のとおりです。
...
| [`006-schema-expressiveness-and-optimization.md`](006-schema-expressiveness-and-optimization.md) | スキーマ表現力 & 最適化強化仕様                      | `Implemented` | [#50](https://github.com/high-soar/taskweave/issues/50), [#51](https://github.com/high-soar/taskweave/issues/51), [#52](https://github.com/high-soar/taskweave/issues/52), [#53](https://github.com/high-soar/taskweave/issues/53), [#54](https://github.com/high-soar/taskweave/issues/54) | 原本 YAML のルートキー対称性統一、非推奨警告ポリシー、メンバー個別稼働曜日、担当者指定、負荷平準化およびタスク引き継ぎの仕様 |
